...
namespace Xunit
{
    ...
    public class EqualException : AssertActualExpectedException
    {
        ...
        public EqualException(object expected, object actual) : base(expected, actual, "Assert.Equal() Failure")
        {
            this.ActualIndex = -1;
        ...
        public EqualException(string expected, string actual, int expectedIndex, int actualIndex) : base(expected, actual, "Assert.Equal() Failure")
        {
        ...
        string CreateMessage()
        {
            ...
            Tuple<string, string> printedExpected = ShortenAndEncode(this.Expected, this.ExpectedIndex, '↓');
            Tuple<string, string> printedActual = ShortenAndEncode(this.Actual, this.ActualIndex, '↑');
