...
namespace Xunit
{
    ...
    public class CollectionException : XunitException
    {
            ...
            : base("Assert.Collection() Failure")
        {
            ...
            this.IndexFailurePoint = indexFailurePoint;
            this.innerException = FormatInnerException(innerException);
            this.innerStackTrace = innerException == null ? null : innerException.StackTrace;
        }
        ...
        public override string StackTrace
        {
            get
            {
                if (this.innerStackTrace == null)
                    return base.StackTrace;

                return this.innerStackTrace + Environment.NewLine + base.StackTrace;
            }
        }
