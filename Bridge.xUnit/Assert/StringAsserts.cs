...
{
    /// <summary>
    /// Provides asserts for <see cref="String"/>'s.
    /// </summary>
    public partial class Assert
    {
        ...
        {
            if (expectedRegexPattern == null) throw new ArgumentNullException(nameof(expectedRegexPattern));
        ...
        {
            if (expectedRegex == null) throw new ArgumentNullException(nameof(expectedRegex));
            ...
            else if (actual != null)
            {
                ...
                while (expectedIndex < expectedLength && actualIndex < actualLength)
                {
                    ...
                    else
                    {
                        if (ignoreCase)
                        {
                            expectedChar = Char.ToUpper(expectedChar);
                            actualChar = Char.ToUpper(actualChar);
                        }
